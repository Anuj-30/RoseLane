                                    ...
                                    products.map((item,index)=>(
                                        ...
                                        md:items-center md:justify-between shadow-md md:p-5 p-2 mb-4'>
                                            <div className='flex  items-center'>
                                                <span className='mr-4 px-1 bg-primary text-white'>0{index+1}</span>
                                                <img src={item.image}alt='cart-image' className='size-12 object-cover mr-4'/>
                                                <div>
                                                    <h5>{item.name}</h5>
                                                ...
                                                items-center mt-2'>
                                                    ...
                                                    onClick={()=>handleQuantity('decrement',item.id)}
                                                     className='size-6 flex items-center justify-end px-1.5 rounded-full
